  ...
  <div class="container mx-auto p-5 md:flex md:justify-center ">
    <div class="w-full    ">
      <div class="ml-2 flex font-semibold  " >
        <span class="p-2 "><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-7 h-6">
      ...
      <div class="md:flex no-wrap md:-mx-2 ">
        ...
        <!-- Left Side -->
        <div class="w-full md:w-3/12 m-4 m-4 rounded-lg shadow-md  border-2 border-black-600">
          <!-- Profile Card -->
          <div class="bg-white p-3  ">
            ...
            >
              <img
                :src="
                  'http://127.0.0.1:8000/storage/images/' + storeData.profile_img
                "
        ...
        <!-- Right Side -->
        <div class="w-full md:w-9/12 m-4 border-2  shadow-md   border-black-600 rounded-lg">
