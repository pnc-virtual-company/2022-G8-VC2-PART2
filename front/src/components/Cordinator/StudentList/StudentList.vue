  ...
  <div class="container text-center w-5/5 h-screen overflow-y-scroll"> -->
    ...
    <!-- <div class="m-auto filter flex justify-around w-11/12 mt-5">
      ...
      <!-- <widget-button @click="storeData.onCreate()">
        <template #default>
          <span class="text-white">Create Student</span>
        </template>
      </widget-button> -->
    ...
    >
      ...
      >
        ...
        <tbody v-for="student in storeData.students" :key="student">
          <tr @click="storeData.viewDetail(student.user.id)" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
            <td>
            ...
            <td class="py-3 px-2"> -->
              ...
              <!-- <widget-DropDown>
                ...
                <template #delete
                  >
                  <span @click="storeData.deleteStudentClicked(student.user.id)">Delete</span
                  >
                </template>
