  ...
  <div  v-if=" storeData.isTrue " >  
    ...
    <div  class=" w-1/2 border-t-4 border-l-4 border-r-4 border-b-4">
      ...
      <div class="flex justify-around mb-4">
        <button @click="dialogDelete = false" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">cancel</button>
        <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Ok</button>
      </div>
  </div>
