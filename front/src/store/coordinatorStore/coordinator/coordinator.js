...
export const userStore = defineStore("user", {
    ...
    actions: {
        ...
        */
        ...
        logOut() {
            axios.post(process.env.VUE_APP_API_URL + "logout", this.token).then((res) => {
                ...
                if (this.newPassword == this.confirmPassword) {
                    axios
                        .post(
                            ...
                            sessionStorage.getItem("coordintor_id"), { password: this.oldPassword, new_password: this.newPassword }
                        )
                        .then((response) => {
