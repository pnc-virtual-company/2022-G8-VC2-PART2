...
export const studentstore = defineStore("student", {
    state: () => ({
        ...
        isEdit: false,
        isShow: true,
        viewDetailId: null, // use in student list toget student id when was clicked
    ...
    actions: {
        ...
        addComment() {
            ...
            commentData.append('student_id', this.viewDetailId)
            commentData.append('user_id', sessionStorage.getItem('coordintor_id'), )
            ...
            // console.log(this.viewDetailId)
            // console.log(commentData)
            // console.log(sessionStorage.getItem('coordintor_id'))
