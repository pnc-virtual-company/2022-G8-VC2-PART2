...
<body>
    <div style="margin:auto;background-color:#eeee;padding:20px; width:75%;">
        ...
        <div style="background-color:#FFAD5C;text-align:center;padding:10px;color:white;">
            <h1 class="">Student Follow Up Management System </h1>
        </div>
        <div style="background-color:white;padding:50px;">
            <h3> Dear {{$data["first_name"]}} ! You are added in PNC student follow up list</h3>
            ...
            <div >
                ...
                <a href="http://localhost:8080" style="text-decoration: none;"> 
                    <button style="background-color:#FFAD5C;padding: 10px 50px;color: white;border-radius: 10px; border:none;"> GET MORE</button> 
                </a>
            </div>
        </div>
    </div>
