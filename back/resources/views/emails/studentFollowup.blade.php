...
<body>
    <div style="margin:auto;background-color:#eeee;padding:20px; width:75%;">
        ...
        <div style="background-color:black;text-align:center;padding:10px;color:white;">
        ...
        <div style="background-color:white;padding:50px;">
            ...
            <div >
                ...
                <a href="http://localhost:8080" style="text-decoration: none;"> 
                    <button style="background-color:black;padding: 10px 50px;color: white;border-radius: 10px; border:none;"> GET MORE</button> 
                </a>
            </div>
        </div>
    </div>
